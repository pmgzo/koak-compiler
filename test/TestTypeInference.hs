...
test1 = testHelper "y = 5" input1 expectedRes1
...
test2 = testHelper "y = 5: x = 6.2" input2 expectedRes2
...
test3 = testHelper "y = 5: x = 6.2" input3 expectedRes3
...
test4 = testHelper "y = 5: x = y" input4 expectedRes4
...
test5 = testHelper "y = 5: x = y" input5 expectedRes5
