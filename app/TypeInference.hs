...
getTypeFromOp ((DataType2.LT op _):xs)    = getTypeFromOp [op]
getTypeFromOp ((DataType2.GT op _):xs)    = getTypeFromOp [op]
getTypeFromOp ((DataType2.EQ op _):xs)    = getTypeFromOp [op]
getTypeFromOp ((DataType2.NOTEQ op _):xs) = getTypeFromOp [op]
